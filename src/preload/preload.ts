...
const IPC = {
  ...
  deleteCook: 'pitboss:cooks:delete',
  renameCook: 'pitboss:cooks:rename',
...
const api = {
  ...
  deleteCook: (id: string) => ipcRenderer.invoke(IPC.deleteCook, id),
  renameCook: (id: string, name: string) => ipcRenderer.invoke(IPC.renameCook, id, name),
